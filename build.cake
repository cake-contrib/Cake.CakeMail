...
var libraryName = "Cake.CakeMail";
var gitHubRepo = "Cake.CakeMail";

var testCoverageFilters = new[]
{
	"+[Cake.CakeMail]*",
	"-[Cake.CakeMail]Cake.CakeMail.Properties.*",
	"-[Cake.CakeMail]Cake.CakeMail.Models.*",
	"-[Cake.CakeMail]*System.Text.Json.SourceGeneration*"
};
